...
namespace DeepeningPJ
{
    ...
    {
        [Header("Animator Layer Index Names")]
        [SerializeField] private string movementLayerName = "Movement";
        ...
        [SerializeField] private string randomIdleParameterName = "RandomIdle";
        ...
        [SerializeField] private string damagedParameterName = "isDamaged";
        [SerializeField] private string deadParameterName = "isDead";

        public int MovementLayerIndex { get; private set; }
        ...
        public int RandomIdleParameterHash { get; private set; }
        ...
        {
            MovementLayerIndex = animator.GetLayerIndex(movementLayerName);
            ...
            RandomIdleParameterHash = Animator.StringToHash(randomIdleParameterName);
